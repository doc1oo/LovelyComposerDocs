...
コードパートで入力したコードに、さまざまなリズムの伴奏をつけて演奏してくれる機能です。（コードが何も入力されていないと、何も鳴らない＆機能しません。）

左上の絵が現在選択されているリズムパターンを表していて、左上の左右の三角ボタンでパターンを変更できます。

4種類のサブパターンから1つを選択するようになっていて、絵の下の 1 / 2 / 3 / 4 の中から1つを選択します。
