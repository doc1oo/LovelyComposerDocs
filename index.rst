...
パート選択で"C"を選択すると、コード入力ができます。


コードは一か所指定すると、次のコード音符が現れるまで、引き続き同じコードを再生されるようになっています。（黒い線が伸びていきます）

途中で止めたい場合はミュート音符を入力してください。
...
プロモードでパン入力タブを選択すると、音を中央 / 左 / 右 のどこから出すか（パン）を音符単位で指定できます。
